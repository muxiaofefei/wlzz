    ...
    $(document).ready(function () {
        $(window).scroll(function () {
            ...
            if (dheight - (scrolltop + wheight) < 300 && ajaxmore) {
                ...
                tags = "<?=$_GET['tag']?>";
                if(search.length>0){
                    ajaxurl = '/site/morequestion.html?page=' + page + '&pagesize=' + pagesize + '&q=<?=$_GET['q']?>'
                }else if(tags.length>0){
                    ajaxurl = '/site/morequestion.html?page=' + page + '&pagesize=' + pagesize +'&tags=<?=$_GET['tag']?>'
                }else{
                    ajaxurl = '/site/morequestion.html?page=' + page + '&pagesize=' + pagesize
                }
                $.ajax({
                    type: "GET",
                    url:ajaxurl,
